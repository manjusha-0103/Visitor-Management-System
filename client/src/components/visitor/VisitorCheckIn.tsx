...
const VisitorForm = lazy(() => import("./VisitorForm"));
const VisitBookSuccess = lazy(() => import("./VisitBookSuccess"));
const CheckInQRCode = lazy(() => import("./CheckInQRCode"));
const FaceCapture = lazy(() => import("./FaceCapture"));
...
export default function VisitorCheckIn() {
  ...
  const [phase, setPhase] = useState<"qr" | "camera" | "form" | "done">(
    isMobile ? "camera" : "qr",
  );
      ...
      >
        <div className="max-w-lg">
          ...
          <div className="h-full overflow-y-auto p-4">
            ...
            {phase === "done" && (
              <Suspense fallback={contentFallback}>
                <VisitBookSuccess setPhase={setPhase} />
              </Suspense>
            )}
          </div>
        </div>
