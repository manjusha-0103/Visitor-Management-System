...
type CheckInFormProps = {
    ...
    register: UseFormRegister<WalkinFormValues>;
    setValue: UseFormSetValue<WalkinFormValues>;
    selectedEmployee: SearchEmployee | null;
    setSelectedEmployee: React.Dispatch<
        React.SetStateAction<SearchEmployee | null>
    >;
        ...
        <FieldGroup className="max-w-xl">
            <FieldSet>
                <FieldGroup className="gap-2">
                    ...
                    {/* Employee Selection (Walk-in only) */}
                    {isWalkIn && (
                        <div className="border border-gray-200 p-4 rounded-xl">
                            <h3 className="font-semibold text-sm mb-1">
                                Whom To Meet
                            ...
                            <EmployeeSearchSelect<WalkinFormValues>
                                employees={employees}
                                isLoading={empSearchLoading}
                                setValue={setValue}
                                employeeSearch={employeeSearch}
                    ...
                    {isWalkIn && (
                        <div className="border border-gray-200 p-4 rounded-xl">
                            ...
                            <CustomInputField<WalkinFormValues>
                                name="purpose"
                                label=""
                                placeholder="Meeting with local clients"
                                control={control}
        ...
        {!visitorEmailVerified && !visitorOtpSent ? (
            ...
            <div className="text-sm font-medium text-green-600">
                ✓ Email verified
                    ...
                    {/* OTP Verification - WALK-IN ONLY */}
                    {isWalkIn && visitorOtpSent && !visitorEmailVerified && (
